...
[
    ...
    *-unknown-mingw32)
    ...
    x86_64-apple-darwin)
        $3='.dylib'
        ;;
    arm-apple-darwin10|i386-apple-darwin11|aarch64-apple-darwin14|x86_64-apple-darwin14|aarch64-apple-darwin16|x86_64-apple-darwin16)
        $2='.a'
        $3='.dylib'
        ;;
    esac
...
case "$1-$2" in
  darwin10-arm|darwin11-i386|darwin14-aarch64|darwin14-x86_64|darwin16-aarch64|darwin16-x86_64)
    $3="ios"
    ;;
  *)
    case "$1" in
